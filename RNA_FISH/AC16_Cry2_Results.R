...
write.csv(repsimaged, file="AC16_Cry2_RepsImaged.csv")
write.csv(df1, file="AC16_Cry2_Dots_Per_Image.csv")
...
#########################NUCLEAR
png("AC16_Cry2NucPerImageMeanSEM.png", height = 3, width = 2.5, units = "in", res = 600)
barplotter(m1,sem1,colours1)
dev.off()

#########################CYTOPLASMIC
png("AC16_Cry2CytPerImageMeanSEM.png", height = 3, width = 2.5, units = "in", res = 600)
...
write.csv(THSD, file="AC16_Cry2_TukeyHSDdata.csv")
write.csv(aovdata, file="AC16_Cry2_ANOVAdata.csv")
