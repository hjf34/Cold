...
write.csv(repsimaged, file="AC16_Nr1d1_RepsImaged.csv")
write.csv(df1, file="AC16_Nr1d1_Dots_Per_Image.csv")
...
#########################NUCLEAR
setwd("~/Documents/RNAFISH/Rplots")
png("AC16_Nr1d1NucPerImageMeanSEM.png", height = 3, width = 2.5, units = "in", res = 600)
barplotter(m1,sem1,colours1)
dev.off()

#########################CYTOPLASMIC
png("AC16_Nr1d1CytPerImageMeanSEM.png", height = 3, width = 2.5, units = "in", res = 600)
...
write.csv(THSD, file="AC16_Nr1d1_TukeyHSDdata.csv")
write.csv(aovdata, file="AC16_Nr1d1_ANOVAdata.csv")
