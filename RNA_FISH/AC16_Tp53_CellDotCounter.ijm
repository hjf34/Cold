...
selectWindow(chan2);
run("Z Project...", "start=4 stop=26 projection=[Max Intensity]");
///////////////////////////////////////////////////
...
roiManager("Select", 1);
run("Find Maxima...", "noise=1600 output=[Single Points]");
...
///TP53 nuclear count
roiManager("Select", 0);
run("Find Maxima...", "noise=1600 output=Count");

///TP53 cytoplasmic count
roiManager("Select", newArray(0,1));
roiManager("XOR");
roiManager("Add");
roiManager("Select", 2);
...
///Path to directory containing Tp53 Deconvolved RNA_FISH images
