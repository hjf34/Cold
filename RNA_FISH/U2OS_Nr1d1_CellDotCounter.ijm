...
selectWindow(chan2);
run("Z Project...", "start=18 stop=23 projection=[Max Intensity]");
...
selectWindow(chan1);
run("Z Project...", "start=10 stop=31 projection=[Max Intensity]");
///////////////////////////////////////////////////
...
run("Z Project...", "start=6 stop=35 projection=[Max Intensity]");
run("Split Channels");
...
run("Z Project...", "start=8 stop=33 projection=[Max Intensity]");
run("Split Channels");
...
///Path to directory containing Nr1d1 Deconvolved RNA_FISH images (U2OS cells)
